    ...
    <header className="sticky top-0 z-50 border-b bg-background/80 backdrop-blur-md">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-3">
          <a
            href="#features"
            className="rounded text-sm text-muted-foreground hover:text-foreground transition-colors hidden sm:block focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
          >
            Features
          </a>
          <a
...
export function Hero() {
  return (
    <section className="relative overflow-hidden py-20 md:py-28">
      ...
      />
      <div
        className="accent-glow absolute right-0 top-1/4 -z-10 hidden h-[28rem] w-[28rem] lg:block"
        aria-hidden="true"
      />
