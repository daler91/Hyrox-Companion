        ...
        <div className="p-4 space-y-3">
          ...
          <div className="rounded-lg border border-success/30 bg-success/5 p-3 space-y-2">
            <div className="flex items-center gap-2">
              ...
              <Badge className="text-[10px] px-1.5 py-0 bg-success/20 text-success border-0 ml-auto">
                Completed
              </Badge>
            </div>
          ...
          <div className="rounded-lg border border-primary/30 bg-primary/5 p-3 space-y-2 relative overflow-hidden">
            ...
            <p className="relative text-xs text-muted-foreground pl-6">
              8x1km run + all stations (AI adjusted based on your progress)
            </p>
          </div>
    ...
    <div className="min-h-screen bg-background" ref={sectionRef}>
        ...
        <div className="container mx-auto px-4 py-3 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <SignInButton mode="modal">
              <Button data-testid="button-login-header" size="sm">
                Log In
              </Button>
            </SignInButton>
          </div>
      ...
      <main>
          ...
          <div className="container mx-auto px-4">
            <div className="text-center mb-14">
              ...
              <p className="fade-up text-lg text-muted-foreground max-w-2xl mx-auto">
                From structured training plans to real-time AI coaching, every tool is designed
                specifically for Hyrox athletes.
              </p>
            </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm leading-relaxed">
                        Log a workout and watch the magic happen. Your AI coach analyzes your
                        performance and automatically adjusts upcoming sessions to keep you
                        progressing.
                      </p>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm leading-relaxed">
                        See your entire training journey in one view. Import CSV plans, schedule
                        them, and track every session with a clean, chronological timeline.
                      </p>
                      <div className="mt-3 flex items-center gap-1.5 text-primary text-sm font-medium">
                ...
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm leading-relaxed">
                        Connect your Strava account and automatically import activities. Heart rate,
                        power, cadence, and effort data flow in seamlessly.
                      </p>
                ...
                <CardContent className="p-6">
                  <div className="flex items-start gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-muted-foreground text-sm leading-relaxed">
                        Track completion rates, training streaks, and personal records across all
                        exercises. See your progress visualized over time.
                      </p>
                      <div className="mt-3 flex items-center gap-1.5 text-primary text-sm font-medium">
        ...
        <section id="how-it-works" className="py-20 md:py-28 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="text-center mb-14">
              <h2 className="fade-up text-3xl md:text-4xl font-bold mb-4">How It Works</h2>
              <p className="fade-up text-lg text-muted-foreground max-w-2xl mx-auto">
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <div className="fade-up text-center">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Upload a CSV training plan or use our built-in 8-week Hyrox template. Set a start
                  date and your timeline is ready.
                </p>
              </div>
              ...
              <div className="fade-up text-center">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Complete your workouts and log the details — times, weights, RPE, notes. Or let
                  Strava auto-import for you.
                </p>
              </div>
              ...
              <div className="fade-up text-center">
                ...
                <p className="text-muted-foreground text-sm leading-relaxed">
                  Your AI coach analyzes your data, identifies weak spots, and automatically
                  modifies upcoming workouts to optimize your prep.
                </p>
              </div>
            </div>
        ...
        <section className="py-20 md:py-28">
          <div className="container mx-auto px-4">
            <div className="text-center mb-14">
              ...
              <p className="fade-up text-lg text-muted-foreground max-w-2xl mx-auto">
                Track every Hyrox discipline with station-specific exercises, times, and personal
                records.
              </p>
            </div>
            <div className="fade-up">
            ...
            <div className="mt-12 grid md:grid-cols-2 gap-8 max-w-3xl mx-auto">
              <div className="fade-up flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Your AI coach identifies which stations you're neglecting and adjusts your plan
              ...
              <div className="fade-up flex gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground text-sm">
                    Ask questions about your training, get exercise tips, or discuss race strategy
                    with an AI that knows your data.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="container mx-auto px-4 relative text-center">
            <div className="max-w-2xl mx-auto">
              ...
              <p className="fade-up text-lg text-muted-foreground mb-8">
                Join athletes who are using AI-powered coaching to prepare for their next Hyrox
                race. Free to get started.
              </p>
              <div className="fade-up">
                <SignInButton mode="modal">
      ...
      <footer className="border-t py-8 bg-muted/20">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <p className="text-sm text-muted-foreground">Train for Hyrox with confidence</p>
          </div>
        </div>
      </footer>
    </div>
