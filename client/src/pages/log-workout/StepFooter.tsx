export function StepFooter({ children }: { readonly children: React.ReactNode }) {
  return (
    <div
      className={
        "fixed inset-x-0 bottom-0 z-40 flex flex-col-reverse gap-2 border-t border-border bg-background/95 px-4 pt-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))] backdrop-blur " +
