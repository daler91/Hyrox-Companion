...
function SidebarProvider({
  ...
  const setOpen = React.useCallback(
    (value: boolean | ((value: boolean) => boolean)) => {
      ...
      // Note: We intentionally omit the 'Secure' attribute here because this app needs to be
      // accessible via local network IPs for testing (where HTTPS is not available), and setting 'Secure'
      // over HTTP causes browsers to reject the cookie, breaking the sidebar state persistence in dev.
  ...
  return (
    <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
      <SheetContent
        ...
        data-slot="sidebar"
        data-mobile="true"
        className="bg-sidebar text-sidebar-foreground w-[var(--sidebar-width)] p-0 pt-[env(safe-area-inset-top)] pb-[env(safe-area-inset-bottom)] [&>button]:hidden"
