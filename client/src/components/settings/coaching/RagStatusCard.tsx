          ...
          <div className="flex items-start gap-2 p-2 rounded-md bg-yellow-500/10 text-yellow-700 dark:text-yellow-400 text-sm">
            ...
            <div>
              ...
              <p className="text-xs mt-0.5">
                Stored: {ragStatus.storedDimension}-dim, expected: {ragStatus.expectedDimension}
                -dim. Click Re-embed All to fix.
              </p>
            </div>
          </div>
        )}
        ...
        <div className="grid grid-cols-3 gap-3 text-center">
          ...
          <div className="p-2 rounded-md bg-muted">
            <p className="text-lg font-semibold">
              {ragStatus.materials.filter((m: any) => m.hasEmbeddings).length}/
              {ragStatus.totalMaterials}
            </p>
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>Embedding status for AI-powered document retrieval</CardDescription>
      </CardHeader>
