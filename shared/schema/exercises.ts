export const EXERCISE_DEFINITIONS = {
  skierg: { label: "SkiErg", category: "functional" as const, fields: ["distance", "time", "weight"] as const },
  sled_push: { label: "Sled Push", category: "functional" as const, fields: ["distance", "time", "weight"] as const },
  sled_pull: { label: "Sled Pull", category: "functional" as const, fields: ["distance", "time", "weight"] as const },
  burpee_broad_jump: { label: "Burpee Broad Jump", category: "functional" as const, fields: ["distance", "time", "reps"] as const },
  rowing: { label: "Rowing", category: "functional" as const, fields: ["distance", "time"] as const },
  farmers_carry: { label: "Farmers Carry", category: "functional" as const, fields: ["distance", "time", "weight"] as const },
  sandbag_lunges: { label: "Sandbag Lunges", category: "functional" as const, fields: ["distance", "time", "weight"] as const },
  wall_balls: { label: "Wall Balls", category: "functional" as const, fields: ["reps", "time", "weight"] as const },
