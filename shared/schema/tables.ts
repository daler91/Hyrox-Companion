...
export const FOOD_SOURCES = ["usda", "off", "fatsecret", "spoonacular", "edamam", "custom"] as const;
...
export const foods = pgTable("foods", {
  ...
  check("foods_source_check", sql`source IN ('usda', 'off', 'fatsecret', 'spoonacular', 'edamam', 'custom')`),
]);
