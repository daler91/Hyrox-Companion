...
export const exerciseSetSchema = z.object({
  ...
  intensity: z.record(z.unknown()).optional().nullable(),
  load: z.record(z.unknown()).optional().nullable(),
  repMode: z.enum(["total", "per_side"]).optional().nullable(),
  tempo: z.record(z.unknown()).optional().nullable(),
  standards: z.record(z.unknown()).optional().nullable(),
...
const measurableSetFields = {
  ...
  intensity: z.record(z.unknown()).nullable().optional(),
  load: z.record(z.unknown()).nullable().optional(),
  repMode: z.enum(["total", "per_side"]).nullable().optional(),
  tempo: z.record(z.unknown()).nullable().optional(),
  standards: z.record(z.unknown()).nullable().optional(),
