...
// Micro display metadata moved to ./micros (a zero-import module) so the client
// can use it without evaluating this module's tables/zod graph; re-exported here
// for back-compat.
export type { MicroDisplayDef, MicroUnit } from "./micros";
export { MICRO_DISPLAY_DEFS } from "./micros";
