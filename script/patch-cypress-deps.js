...
try {
  ...
  if (
    ...
    (fs.existsSync(simpleGitPath) ||
      fs.existsSync(serializeJsPath) ||
      fs.existsSync(engineIoPath) ||
      fs.existsSync(flattedPath) ||
      fs.existsSync(wsPath) ||
      fs.existsSync(esbuildPath) ||
      fs.existsSync(atEsbuildPath) ||
      fs.existsSync(axiosPath))
  ) {
