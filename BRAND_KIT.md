...
> Drop this file into your repo (e.g. `docs/BRAND.md`) and reference it when asking Claude Code to build UI. Everything here is tokenized so it pastes cleanly into Tailwind, CSS variables, or a design-system package.
