...
export function prescribedSetToLogRow(
  ...
  return {
    ...
    stepRole: p.stepRole,
    groupId: p.groupId,
    intensity: p.intensity as InsertExerciseSet["intensity"],
    load: p.load as InsertExerciseSet["load"],
    repMode: p.repMode,
    tempo: p.tempo as InsertExerciseSet["tempo"],
    standards: p.standards as InsertExerciseSet["standards"],
    notes: p.notes,
