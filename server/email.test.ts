...
import { buildWeeklySummaryEmail, buildMissedWorkoutEmail, WeeklySummaryData, MissedWorkoutData } from './email';
...
describe('email generation', () => {
  ...
  describe('buildMissedWorkoutEmail', () => {
    ...
    it('formats subject correctly for plural workouts', () => {
      const missed = [...missedWorkouts, { date: 'Oct 4', focus: 'Run', mainWorkout: '5k easy pace' }];
