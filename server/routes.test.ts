...
vi.mock("./routes/planRecovery", () => ({ default: { name: "planRecoveryRoutes" } }));
...
vi.mock("./routes/sessionGrades", () => ({ default: { name: "sessionGradesRoutes" } }));
...
describe("registerRoutes", () => {
  ...
  it("should mount all application routers", async () => {
    ...
    expect(app.use).toHaveBeenCalledWith(planRecoveryRoutes);
    expect(app.use).toHaveBeenCalledWith(planProposalRoutes);
